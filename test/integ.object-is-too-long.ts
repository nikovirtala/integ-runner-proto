...
class StackUnderTest extends Stack {
  ...
  constructor(scope: Construct, id: string) {
    ...
    const objectIsTooLong = new aws_lambda_nodejs.NodejsFunction(
      this,
      "objectIsTooLong",
      {
        entry: path.join(
          __dirname,
          "../src/functions/object-is-too-long/index.ts"
        ),
        architecture: aws_lambda.Architecture.ARM_64,
        runtime: aws_lambda.Runtime.NODEJS_18_X,
        environment: {
    ...
    objectIsTooLong.addEventSource(
    ...
    table.grantReadWriteData(objectIsTooLong);
...
/* Assert the result from the dynamodb table
  the item in question is created by the Lambda Function *objectIsTooLong*
